...
- Web pages: Tera templates, HTMX AJAX, Alpine.js UI/UX
...
- Full-Text Search: Powered by Tantivy for fast, accurate place searches
...
- Event Streaming: Real-time place event publishing with audit logging
